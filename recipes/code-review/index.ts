...
const inputSchema = z.object({
  ...
  focus: z
    .array(z.enum(["bug", "style", "security", "performance"]))
...
export const codeReviewRecipe: Recipe<
      ...
      [
        {
          role: "system",
          content:
            "Return JSON with categorized code review findings. Be concise and actionable.",
        },
